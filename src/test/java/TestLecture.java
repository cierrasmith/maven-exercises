...
public class TestLecture {
    ...
    public void testIfObjectsAreDifferent() {
        ...
        assertNotSame(sheep, dog); // passes test because they are not the same
        assertSame(sheep, clonedSheep); // new object wasn't created so this should pass because they are the same
    }
